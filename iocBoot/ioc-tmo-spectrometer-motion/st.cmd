...
epicsEnvSet("LOCATION", "PLC:TMO:SPEC" )
...
epicsEnvSet("IPADDR",           "172.21.132.142")
epicsEnvSet("AMSID",            "172.21.132.142.1.1")
...
epicsEnvSet("PREFIX",         "PLC:TMO:SPEC:")
...
epicsEnvSet("DESC",            "Main.M1 / LensX")
epicsEnvSet("EGU",             "mm")
epicsEnvSet("PREC",            "3")
...
epicsEnvSet("DESC",            "Main.M2 / FoilX")
epicsEnvSet("EGU",             "mm")
epicsEnvSet("PREC",            "3")
epicsEnvSet("AXISCONFIG",      "")
epicsEnvSet("ECAXISFIELDINIT", "")
...
epicsEnvSet("DESC",            "Main.M3 / ZonePlateX")
epicsEnvSet("EGU",             "mm")
epicsEnvSet("PREC",            "3")
epicsEnvSet("AXISCONFIG",      "")
epicsEnvSet("ECAXISFIELDINIT", "")
...
epicsEnvSet("DESC",            "Main.M4 / ZonePlateY")
epicsEnvSet("EGU",             "mm")
epicsEnvSet("PREC",            "3")
epicsEnvSet("AXISCONFIG",      "")
epicsEnvSet("ECAXISFIELDINIT", "")
...
epicsEnvSet("DESC",            "Main.M5 / ZonePlateZ")
epicsEnvSet("EGU",             "mm")
epicsEnvSet("PREC",            "3")
epicsEnvSet("AXISCONFIG",      "")
epicsEnvSet("ECAXISFIELDINIT", "")
...
epicsEnvSet("DESC",            "Main.M9 / YagTheta")
epicsEnvSet("EGU",             "mm")
epicsEnvSet("PREC",            "3")
epicsEnvSet("AXISCONFIG",      "")
epicsEnvSet("ECAXISFIELDINIT", "")
...
dbLoadRecords("iocSoft.db", "IOC=PLC:TMO:SPEC")
dbLoadRecords("save_restoreStatus.db", "P=PLC:TMO:SPEC:")
dbLoadRecords("caPutLog.db", "IOC=${IOC}")

## TwinCat System Databse files ##
dbLoadRecords("TwinCAT_TaskInfo.db", "PORT=ASYN_PLC, PREFIX=PLC:TMO:SPEC")
dbLoadRecords("TwinCAT_AppInfo.db", "PORT=ASYN_PLC, PREFIX=PLC:TMO:SPEC")
...
save_restoreSet_status_prefix( "PLC:TMO:SPEC:" )
